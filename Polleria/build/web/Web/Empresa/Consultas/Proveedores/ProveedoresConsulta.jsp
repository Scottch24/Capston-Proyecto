...
<table id="example" class=" table table-striped" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop" value="Editar" onclick="abrirModal('<%=c.getIdProveedor()%>', '<%=c.getRazonSocial()%>', '<%=c.getRUC()%>', '<%=c.getTelefono()%>', '<%=c.getContacto()%>')">
            ...
            <td><a href="#" onclick="Eliminar('<%=c.getIdProveedor()%>')">
