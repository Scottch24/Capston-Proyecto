...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/Web/js/Empresa/Marcas/MethodAjax.js"></script>
            ...
            <div class="modal-dialog modal-dialog-scrollable" style="width: 1500px; height: 500px; max-width: 1500px;  
                ...
                <div class="modal-content" style="width: 1450px; margin: 10px auto; padding-bottom: 0;">
                    <div class="modal-header" style="padding: 0">
                        <h5 class="modal-title" id="staticBackdropLabel" >Registrar Marca</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" style="padding: 0;">
                        <form action="${pageContext.request.contextPath}/Web/Empresa/NMarca.jsp" method="post" id="formCate" >
                            <fieldset class="row gy-1 gx-1 align-items-center">
                                <div class="form-group col-6">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-1 bg-secondary">Nombre:</label>
                                    <input path="Nombre" class="form-control" type="text" name="txtMarca" id="txtMarca" placeholder="Nombre De Marca" />
                                </div>
