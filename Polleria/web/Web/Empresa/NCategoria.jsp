<%-- 
    Document   : NCategoria
    Created on : 25-ene-2022, 20:03:41
    Author     : MIGUE
--%>
...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/Web/js/Empresa/Categoria/MethodAjax.js"></script>
            ...
            <div class="modal-dialog modal-dialog-scrollable" style="width: 1500px; height: 500px; max-width: 1500px;  
                ...
                <div class="modal-content" style="width: 1450px; margin: 10px auto; padding-bottom: 0;">
                    ...
                    <div class="modal-body" style="padding: 0;">
                        <form action="${pageContext.request.contextPath}/Web/Empresa/NCategoria.jsp" method="post" id="formCate" >
                            <fieldset class="row gy-1 gx-1 align-items-center">
                                <div class="form-group col-6">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-1 bg-secondary">Nombre:</label>
                                    <input path="Nombre" class="form-control" type="text" name="txtNombreCate" id="txtNombreCate" placeholder="Nombre De Categoria" onkeypress="return soloLetras(event)" required>
