...
<html>
    ...
    <body>
            ...
            <div class="home-Contenido">
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="height: 100px; justify-content: center; align-items: center;">
                    <div class="btn-group me-2" role="group" aria-label="First group">
                        <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="BtnCliente()">Seleccionar Un Cliente</button>
                    </div>
                    <div class="btn-group me-2" role="group" aria-label="Second group">
                        <button type="button" class="btn btn-secondary"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="BtnProductoCarrito()">Seleccionar Un Producto</button>
                    </div>
                </div>
        ...
        <script src="${pageContext.request.contextPath}/Web/js/Empresa/Ventas/MethodAjax.js"></script>
