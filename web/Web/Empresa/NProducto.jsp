...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/Web/js/Empresa/Productos/MethodAjax.js"></script>
        ...
        <section class="home-section" style="padding: 100px">
            ...
            <div class="home-Contenido">
                <div class="Operaciones">
                    <button type="button" class="btnNuevo"  data-bs-toggle="modal" data-bs-target="#staticBackdrop"  onclick="nuevo()" >
                        Nuevo
                    </button>
                </div>
                <div class="details">
            ...
            <div class="modal-dialog modal-dialog-scrollable" style="width: 1500px; height: 500px; max-width: 1500px;  
                ...
                <div class="modal-content" style="width: 1450px; margin: 10px auto; padding-bottom: 0;">
                    ...
                    <div class="modal-body" style="padding: 0;">
                        <form action="${pageContext.request.contextPath}/Web/Empresa/NProducto.jsp" method="post" id="form"  enctype="multipart/form-data" >
                            <fieldset class="row gy-1 gx-1 align-items-center">
                                <div class="form-group col-6" id="cajaId">
                                    <label class="col-form-label" class="badge rounded-pill p-1 bg-secondary">Código del
                                        Producto: </label>
                                    <input path="idEmpleado" class="form-control" type="text"  name="txtIdProducto" id="txtIdProducto" placeholder="ID De Producto" autofocus="true" />
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-1 bg-secondary">Nombre:</label>
                                           <input path="Nombre" class="form-control" type="text" name="txtNombre" id="txtNombre" placeholder="Nombre De Producto" onkeypress="return soloLetras(event)" required>
                                ...
                                <div class="form-group col-6">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-1 bg-secondary">Precio</label>
                                    <input path="numero" class="form-control" type="number" step="any" name="txtPrecio" id="txtPrecio" placeholder="Precio De Producto" required>
                                    <div class="valid-feedback">
                                        Correcto!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-6" >
                                    <label class="col-form-label" class="badge rounded-pill p-2 bg-secondary"> Stock </label>
                                    <input path="stock" class="form-control" type="number" name="txtStock" id="txtStock" placeholder="Cantidad De Productos" onkeypress="return valideKey(event);" required>
                                    <div class="valid-feedback">
                                        Correcto!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-6">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-2 bg-secondary">Imagen</label>
                                    <input path="Usuario" class="form-control" type="file" name="txtFileFoto" id="txtFileFoto"  accept="image/*" required>
                                    <div class="valid-feedback">
                                        Correcto!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-12">
                                    <label class="col-form-label"
                                           class="badge rounded-pill p-2 bg-secondary">Descripcion</label>
                                    <textarea class="form-control" rows="5" name="txtDescripcion" id="txtDescripcion" style="height: 200px" ></textarea>
                                    <div class="valid-feedback">
                                        Correcto!
                                    </div>
                                    <div class="invalid-feedback">
