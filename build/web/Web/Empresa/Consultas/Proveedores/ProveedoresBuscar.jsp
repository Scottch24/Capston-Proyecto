...
<%
    ...
    List<Proveedores> lista = daoPro.Buscar(Letra);
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="#"  value="Editar" onclick="abrirModal('<%=c.getIdProveedor()%>', '<%=c.getRazonSocial()%>', '<%=c.getRUC()%>', '<%=c.getTelefono()%>', '<%=c.getContacto()%>')">
